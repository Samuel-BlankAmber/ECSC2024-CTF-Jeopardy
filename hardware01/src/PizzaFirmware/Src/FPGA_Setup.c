...
#define ADDRESS_SETUP_TIME 6
#define DATA_SETUP_TIME 24
#define PRESCALER RCC_MCODIV_2
...
int FPGA_init() {
  ...
  Timing.CLKDivision = 3; // don't care
  ...
  ExtTiming.CLKDivision = 3; // don't care
  ...
  */
  ...
  //Clock FPGA
  __HAL_RCC_MCO1_CONFIG(RCC_MCO1SOURCE_PLLCLK, PRESCALER);
